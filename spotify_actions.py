...
def getRecommendations(user_token, topArtistIDs, vibe, songList=[]):
    ...
    if vibe == "happy":
        happy_recommendations = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[:4]), seed_genres=['happy'], min_valence=0.75, min_energy=0.75, limit=20)['tracks']
        happy_recommendations2 = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[4:8]), seed_genres=['happy'], min_valence=0.75, min_energy=0.75, limit=20)['tracks']
        ...
        sad_recommendations = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[:4]), seed_genres=['sad'], max_valence=0.25, max_energy=0.4, limit=20)['tracks']
        sad_recommendations2 = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[4:8]), seed_genres=['sad'], max_valence=0.25, max_energy=0.4, limit=20)['tracks']
        ...
        sad_recommendations = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[:5]), min_energy=0.75, limit=10)['tracks']
        sad_recommendations2 = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[5:10]), min_energy=0.75, limit=10)['tracks']
        ...
        chill_recommendations = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[:4]), seed_genres=['chill'], max_energy=0.25, limit=20)['tracks']
        chill_recommendations2 = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[4:8]), seed_genres=['chill'], max_energy=0.25, limit=20)['tracks']
        ...
        dance_recommendations = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[:5]), min_danceability=0.8, limit=20)['tracks']
        dance_recommendations2 = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[5:10]), min_danceability=0.8, limit=20)['tracks']
        ...
        angry_recommendations = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[:5]), max_valence=0.25, min_energy=0.75, limit=20)['tracks']
        angry_recommendations2 = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[5:10]), max_valence=0.25, min_energy=0.75, limit=20)['tracks']
        ...
        songSet = set()
        study_recommendations = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[:4]), seed_genres=['study'], limit=20)['tracks']
        study_recommendations2 = spotifyObject.recommendations(country='US', seed_artists=list(topArtistIDs[4:8]), seed_genres=['study'], limit=20)['tracks']
...
#        songSet = set()
        workout_recommendations = spotifyObject.recommendations(country='US', seed_tracks=songList[:4], seed_genres=['work-out'], min_energy=0.8, limit=20)['tracks']
        workout_recommendations2 = spotifyObject.recommendations(country='US', seed_tracks=songList[4:8], seed_genres=['work-out'], min_energy=0.8, limit=20)['tracks']
